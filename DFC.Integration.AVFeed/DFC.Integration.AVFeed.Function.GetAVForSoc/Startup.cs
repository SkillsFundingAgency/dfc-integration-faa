...
namespace DFC.Integration.AVFeed.Function.GetAVForSoc
{
    ...
    {
        public static async Task<MappedVacancyDetails> RunAsync(SocMapping myQueueItem, RunMode mode)
        {
            return await RunAsync(myQueueItem, mode, null, null);
        }
        public static async Task<MappedVacancyDetails> RunAsync(SocMapping myQueueItem, RunMode mode, IAsyncCollector<AuditRecord<object, object>> asyncCollector, AuditRecord<object,object> masterRecord)
        {
