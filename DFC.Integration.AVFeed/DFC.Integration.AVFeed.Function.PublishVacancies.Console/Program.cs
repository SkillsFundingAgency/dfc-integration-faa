    ...
    class Program
    {
        static void Main()
        {
            ...
            try
            {
                ...
                var input = TestUtility.ReadQueue<ProjectedVacancyDetails>(nameof(IProjectVacanciesFunc));
                while (input != null)
                {
                    ...
                    input = TestUtility.ReadQueue<ProjectedVacancyDetails>(nameof(IProjectVacanciesFunc));
                }
            }
            catch (Exception ex)
            {
